@extends('layouts.app')
@section('title', 'Roesdi | Data Contacts')
@section('content')
<!-- MAIN CONTENT-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- <form action="{{ route('contacts.destroy', $contact->id) }}" method="post" style="display: inline">
                                                            <input type="submit" class="btn btn-default" value="Hapus" style="font-size:14px; padding: 0; background-color: transparent; color:#007bff;">
                                                            @method('delete')
                                                            @csrf
                                                        </form> --}}
